  ...
  const renderGenericTool = (toolInvocation: ToolInvocation, index: number) => {
      ...
      return (
        ...
        >
          <CardContent className="p-3">
            ...
            <pre className="overflow-x-auto rounded bg-amber-100/50 p-2 text-xs text-amber-800 dark:bg-amber-900/20 dark:text-amber-200">
    ...
    if (toolInvocation.state === "result") {
      return (
        <Card
          key={index}
          className="border-gray-200 bg-gray-50/50 dark:border-gray-800 dark:bg-gray-950/20"
        >
          <CardContent className="p-3">
            <div className="mb-2 flex items-center gap-2">
            ...
            <pre className="overflow-x-auto rounded bg-gray-100/50 p-2 text-xs text-gray-800 dark:bg-gray-900/20 dark:text-gray-200">
  ...
  const renderSourcePart = (part: SourcePart, index: number) => (
    ...
    >
      <CardContent className="p-3">
        ...
        <pre className="overflow-x-auto rounded bg-purple-100/50 p-2 text-xs text-purple-800 dark:bg-purple-900/20 dark:text-purple-200">
    ...
    >
      <CardContent className="p-3">
        <div className="mb-2 flex items-center gap-2">
          ...
          <Badge
            variant="secondary"
            className="bg-indigo-100 text-xs text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200"
          >
            {part.mimeType}
          </Badge>
        </div>
        <div className="rounded bg-indigo-100/50 p-2 text-xs text-indigo-800 dark:bg-indigo-900/20 dark:text-indigo-200">
          {part.data.length > 100
            ? `${part.data.substring(0, 100)}...`
            : part.data}
        </div>
      </CardContent>
    </Card>
  ...
  return (
    ...
    >
      ...
      <div className={cn("max-w-[85%] space-y-2", isUser && "order-first")}>
        ...
        >
          <CardContent className="p-4">{renderParts()}</CardContent>
        </Card>
      </div>
